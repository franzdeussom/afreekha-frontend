...
export declare class Select2 implements ControlValueAccessor, OnInit, DoCheck, AfterViewInit {
    ...
    idLabel: import("@angular/core").Signal<string>;
    idCombo: import("@angular/core").Signal<string>;
    idOptions: import("@angular/core").Signal<string>;
    idOverlay: import("@angular/core").Signal<string>;
    title: import("@angular/core").InputSignal<string>;
    ariaLabelledby: import("@angular/core").InputSignal<string>;
    ariaDescribedby: import("@angular/core").InputSignal<string>;
    ariaInvalid: import("@angular/core").InputSignalWithTransform<boolean, unknown>;

...
export declare class Select2Utils {
    ...
    static optionIsNotInFilteredData(filteredData: Select2Data, option: Select2Option | null | undefined): boolean;
    static getPreviousOption(filteredData: Select2Data, hoveringOption: Select2Option | null | undefined): Select2Option;
    static getNextOption(filteredData: Select2Data, hoveringOption: Select2Option | null | undefined): Select2Option;
